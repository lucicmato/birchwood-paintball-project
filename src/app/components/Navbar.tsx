  ...
  return (
    <nav className="bg-forest-dark text-white py-4 px-6 shadow-lg relative">
      ...
      <div className="container mx-auto flex items-center justify-between relative z-10">
        ...
        {/* Mobile Menu */}
        <div
          className={`fixed top-0 right-0 h-full w-64 bg-tactical-dark transform transition-transform duration-300 ease-in-out md:hidden ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}
        >
